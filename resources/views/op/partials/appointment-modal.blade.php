...
<div class="form-group start-date">
	...
	<div class="input-group">
		...
		<p class="text-danger" name="dayE"></p>
	</div>
	<div class="input-group end-date-time col-md-12">
		...
		<div class="col-md-6">
			...
			<p class="text-danger " name="start_atE"></p>
			</div>
			<div class="col-md-6 col-xs-12">
			<p class="text-danger " name="end_atE"></p>
			</div>
	</div>
</div>
