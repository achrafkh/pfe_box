...
<script>
    $(function () {
            ...
            $.ajax({
                ...
                .done(function (data) {
                    ...
                    for (i = 0; i < data.length; ++i) {
                        data[i].week = moment().day("Monday").week(data[i].date).format('MMMM Do YYYY');
                    }
                    chart.setData(data);
                })
                .fail(function () {
        ...
        var chart = Morris.Bar({
            ...
            xkey: 'week', // Set the key for X-axis
            ykeys: ['done','pending','rescheduled'], // Set the key for Y-axis
            labels: ['done','pending','rescheduled'] // Set the label when bar is rolled over
        });
